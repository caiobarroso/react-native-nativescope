  ...
  return (
    <g>
      ...
      <circle
        ...
        cy={y + 19}
        r="4"
        data-svg-accent-fill={active || undefined}
        data-svg-subtle-fill={!active || undefined}
      />
      <text x={x + 31} y={y + 23} data-svg-label>
        {label}
      </text>
      <text x={x + 18} y={y + 43} data-svg-faint>
        {detail}
      </text>
    </g>
  );
    ...
    <figure data-goal-organism>
      <div data-goal-organism-canvas>
        ...
        >
          ...
          <text x="490" y="28" textAnchor="middle" data-svg-eyebrow data-svg-muted-fill>
            ONE LOCAL CORE · MODULES ONLY WHEN NEEDED
          </text>

          <path
            d="M420 197 C350 150 322 91 226 91"
            data-goal-tentacle="active"
            markerEnd="url(#goal-tentacle-active)"
          />
          <path
            d="M410 226 C344 220 314 205 226 205"
            data-goal-tentacle="active"
            markerEnd="url(#goal-tentacle-active)"
          />
          <path
          ...
          <path
            d="M560 197 C630 150 658 91 754 91"
            data-goal-tentacle
            markerEnd="url(#goal-tentacle-dot)"
          />
          <path
            d="M570 226 C636 220 666 205 754 205"
            data-goal-tentacle
            markerEnd="url(#goal-tentacle-dot)"
          />
          <path
            d="M565 257 C640 278 670 319 754 319"
            data-goal-tentacle
            markerEnd="url(#goal-tentacle-dot)"
          />
          <path
            d="M542 282 C615 354 650 433 754 433"
            data-goal-tentacle
            markerEnd="url(#goal-tentacle-dot)"
          />
          ...
          />
          <text x="490" y="280" textAnchor="middle" data-svg-accent-text>
            local core
          </text>
